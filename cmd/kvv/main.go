...
type acvConfig struct {
	ConfigServers []string `yaml:"vaults"`
}
...
func main() {
	...
	info.SetCell(1, 0, tview.NewTableCell("<v> Change config server").SetStyle(tcell.Style{}.Bold(true)))
	info.SetCell(2, 0, tview.NewTableCell("<c> Copy selected value").SetStyle(tcell.Style{}.Bold(true)))
	info.SetCell(3, 0, tview.NewTableCell("<q> Quit ACV").SetStyle(tcell.Style{}.Bold(true)))
